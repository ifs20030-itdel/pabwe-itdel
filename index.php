    ...
    <div class="continer">
        <div class="card">
            <div class="card-body w-50 mx-auto">
                ...
                <h3 class="text-center">11S20030_Vistar Tiop Raja Gukguk</h3>
                ...
                <div class="list-group">
                    ...
                    <a href="assets/week9_sesi2/11s20030/public/sapa-public.php" target="_blank" class="list-group-item list-group-item-action">Minggu Ke-9 Sesi 2</a>
                </div>
            </div>
        </div>
    </div>
